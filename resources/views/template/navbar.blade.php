...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{Storage::url('/assets/logo-icon.png')}}">
        ...
        <div class="container-fluid">
            <a href="/index" class="navbar-brand">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 640 480" style="enable-background:new 0 0 640 480; width: 20%; fill: #0253B3" xml:space="preserve">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item m-4">
                    <a class="navbar-link text-decoration-none" href="/index">Home</a>
                </li>
                <li class="nav-item m-4">
                    <a class="navbar-link text-decoration-none" href="/course">Course</a>
                </li>
                <li class="nav-item m-4">
                    <a class="navbar-item text-decoration-none" href="/aboutus">About Us</a>
                </li>
                <li class="nav-item m-3">
                    ...
                    <span class="navbar-text">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light text-secondary" aria-labelledby="navbarDarkDropdownMenuLink">
                                <li class="dropdown-item">
                                    <a class="navbar-item text-decoration-none" href="/user">Profile</a>
                                </li>
                                <li class="dropdown-item">
                                    <a class="navbar-item text-decoration-none" href="/user/#my-courses">My Course</a>
                                </li>
                                <hr>
                                <form action="/logout" method="POST">
                                    @csrf
                                    <button type="submit" class="dropdown-item text-danger">Logout <i class="bi bi-box-arrow-right"></i></button>
                                </form>
                            </ul>
                        </div>
                    </span>
            ...
            @guest
            <a class="navbar-item text-decoration-none mx-5" href="/login">
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" style="width: 9%; fill: #0253B3"><path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z"/><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,2,0,7,7,0,0,1,14,0,1,1,0,0,0,2,0A9.01,9.01,0,0,0,12,14Z"/></svg>
            </a>
            @endguest
        </div>
    </nav>
...
{{--
    <div class="bg-light">
        <span class="text-secondary">contact us &emsp; @hitchhiker.id</span>
        <img src="{{Storage::url('sosmed.png')}}" alt="social-media-icon">
    </div> --}}
