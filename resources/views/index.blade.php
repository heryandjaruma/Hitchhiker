...
@section('content')
    ...
    @endif
    <div class="container pb-5" id="cont">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <video class="video-fluid" autoplay loop muted>
                            <source src="{{asset('video/sungai.mp4')}}" type="video/mp4"/>
                        </video>

                        <div class="carousel-caption d-none d-md-block position-absolute top-50 z-1">
                ...
                <path d="M330.83,387.3c1.74-2.45,3.29-4.98,4.42-7.69c1.66-4.01,2.44-8.1,2.35-12.28c-0.09-4.18-1.12-8.32-3.08-12.43
                    ...
                    c-1.3,1.49-2.72,2.52-4.24,3.09C313.76,377.82,312.21,378.02,310.65,377.87z"/>
                            ...
                            <h1>HITCHHIKER</h1>
                            <p>Currently the best leading LMS for online courses you can find on the internet!</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <video class="video-fluid" autoplay loop muted>
                            <source src="{{asset('video/laut.mp4')}}" type="video/mp4"/>
                        </video>

                    <div class="carousel-caption d-none d-md-block position-absolute top-50 z-1">
                        <div class="container justify-content-center w-50 ">
                            <img src="{{Storage::url('/assets/laravel.png')}}" class="card-img-top w-25 m-3" alt="...">
                        </div>
                        <h1>PHP Framework</h1>
                        <p>Made with Laravel 8</p>
                    </div>
                    </div>
                    <div class="carousel-item">
                        <video class="video-fluid" autoplay loop muted>
                            <source src="{{asset('video/gunung.mp4')}}" type="video/mp4"/>
                        </video>
        ...
        <div class="row p-5">
            <div class="container">
                <div class="row my-5">
                    <a href="#trending-courses" style="text-decoration: none">
                        <div class="h1 text-primary" id="trending-courses">Trending Courses
        ...
        <div class="row p-5">
            <div class="container">
                <div class="row my-5">
                    <a href="#all-courses" style="text-decoration: none">
                        <div class="h1 text-primary" id="all-courses">All Courses
                        </div>
                    </a>
                    <hr>
                </div>
